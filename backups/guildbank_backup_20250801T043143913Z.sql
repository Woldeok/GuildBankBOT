...
INSERT INTO `guild_bank` VALUES (1,200000001400.81);
...
INSERT INTO `guild_stocks` VALUES (1,10,115354,116231.54);
...
CREATE TABLE `guild_transactions` (
  ...
  `type` enum('deposit','withdrawal','loan','repayment','loan_collection','guild_buy','tax_collection') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `stocks` VALUES (1,'삼전','삼성전자',80000,'2025-08-01 13:30:42'),(2,'하이닉스','SK하이닉스',130000,'2025-08-01 13:30:42'),(3,'카카오','카카오',120000,'2025-08-01 13:30:42'),(4,'네이버','네이버',350000,'2025-08-01 13:30:42'),(5,'LG화학','LG화학',700000,'2025-08-01 13:30:42'),(6,'현대차','현대차',200000,'2025-08-01 13:30:42'),(7,'기아','기아',90000,'2025-08-01 13:30:42'),(8,'셀트리온','셀트리온',250000,'2025-08-01 13:30:42'),(9,'포스코','POSCO홀딩스',400000,'2025-08-01 13:30:42'),(10,'KB금융','KB금융',60000,'2025-08-01 13:30:42');
...
INSERT INTO `users` VALUES (886478189520637992,'weoldeog1',43728013618.00,'2025-07-29 11:00:38',NULL,NULL),(889085646768078850,'atcode1',100000.00,'2025-07-29 09:35:28',NULL,'2025-07-29 09:40:00');
...
-- Dump completed on 2025-08-01 13:31:44
